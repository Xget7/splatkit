...
[`scripts/prepare-world.sh`](../../scripts/prepare-world.sh) builds these tools and runs `ply2spz`, `splat_lod_build` and `splat_collider` in order; the [React Native guide](../react-native-splatkit/README.md#preparing-a-world) explains its flags.
